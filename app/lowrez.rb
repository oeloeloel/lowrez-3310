# Emulation of a LOWREZ canvas. Don't change this file unless you know what you're doing :-)
# Head over to main.rb and study the code there.

LOWREZ_WIDTH           = 84
LOWREZ_HEIGHT          = 48
LOWREZ_ZOOM            = 10
LOWREZ_ZOOMED_WIDTH     = LOWREZ_WIDTH * LOWREZ_ZOOM
LOWREZ_ZOOMED_HEIGHT     = LOWREZ_HEIGHT * LOWREZ_ZOOM
LOWREZ_X_OFFSET        = (1280 - LOWREZ_ZOOMED_WIDTH).half
LOWREZ_Y_OFFSET        = ( 720 - LOWREZ_ZOOMED_HEIGHT).half
...
class LowrezOutputs
  ...
  def background_color= opts
    ...
    outputs_lowrez.solids << [0, 0, LOWREZ_WIDTH, LOWREZ_HEIGHT, @background_color]
  end
...
module GTK
  class Runtime
    ...
    def tick_core
      ...
      @args.outputs
           .sprites << { x: (1280 - LOWREZ_ZOOMED_WIDTH) / 2,
                         y: (720 - LOWREZ_ZOOMED_HEIGHT) / 2,
                         w: LOWREZ_ZOOMED_WIDTH,
                         h: LOWREZ_ZOOMED_HEIGHT,
                         source_x: 0,
                         source_y: 0,
                         source_w: LOWREZ_WIDTH,
                         source_h: LOWREZ_HEIGHT,
                         path: :lowrez }
    end
  end
end
